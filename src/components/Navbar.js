...
const CustomLink = memo(({ href, title, className = "" }) => {
    ...
    return (
        <Link href={href} className={`${className} relative group`}>
            {title}
            <span
                className={`h-[1px] inline-block w-0 bg-dark absolute left-0 -bottom-0.5 group-hover:w-full 
...
const CustomMobileLink = memo(({ href, title, className = "", toggle }) => {
    ...
    return (
        <button href={href} className={`${className} relative group text-light dark:text-dark my-2`} onClick={handleClick}>
            {title}
            <span
                className={`h-[1px] inline-block w-0 bg-light absolute left-0 -bottom-0.5 group-hover:w-full 
              transition-[width] ease duration-300 ${router.asPath === href ? "w-full" : "w-0"
                    } dark:bg-dark`}
            >
                &nbsp;
        ...
        z-10 lg:px-16 md:px-12 sm:px-8'>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    <motion.a href="https://x.com/AdityaP62016807" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mr-3'
                    >
                    ...
                    <motion.a href="https://github.com/Aadi0729" target={"_blank"}
                    ...
                    <motion.a href="https://www.linkedin.com/in/aditya-pateriya7781/" target={"_blank"}
                        className='w-6 mx-3'
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                    >
